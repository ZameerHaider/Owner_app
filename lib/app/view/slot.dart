          ...
          body: value.apiCalled == false
              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    (index) => Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                value.dayList[value.slotList[index].weekId as int].toString(),
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () {
                                        value.onEdit(value.slotList[index].id as int);
                                      },
                                      child: const Icon(
                                        Icons.edit_note,
